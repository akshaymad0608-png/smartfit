...
const About: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in pb-20 bg-brand-surface">
      ...
      <div className="bg-brand-card pt-24 pb-20 border-b border-brand-gray/10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <span className="text-brand-green font-extrabold uppercase tracking-widest text-xs mb-4 block">Our Philosophy</span>
          <h1 className="text-5xl md:text-6xl font-black text-brand-darkGreen mb-8 tracking-tight">Making Fitness <br/><span className="text-gradient">Human Again.</span></h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl font-bold text-brand-darkGreen mb-10">Why SmartFit?</h2>
            <div className="space-y-10">
              <div className="flex group">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-brand-card border border-brand-gray/10 text-brand-green shadow-card group-hover:scale-110 transition-transform">
                    <Target size={32} />
                  </div>
                </div>
                <div className="ml-8">
                  <h3 className="text-xl font-bold text-brand-darkGreen mb-2">Focus on Habits, Not Hype</h3>
              ...
              <div className="flex group">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-brand-card border border-brand-gray/10 text-brand-blue shadow-card group-hover:scale-110 transition-transform">
                    <Heart size={32} />
                  </div>
                </div>
                <div className="ml-8">
                  <h3 className="text-xl font-bold text-brand-darkGreen mb-2">Health First Approach</h3>
                  <p className="text-brand-gray leading-relaxed">
              ...
              <div className="flex group">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-brand-card border border-brand-gray/10 text-brand-darkGreen shadow-card group-hover:scale-110 transition-transform">
                    <Shield size={32} />
                  </div>
                </div>
                <div className="ml-8">
                  <h3 className="text-xl font-bold text-brand-darkGreen mb-2">Science-Backed Methods</h3>
                  <p className="text-brand-gray leading-relaxed">
      ...
      <div className="bg-brand-card py-24 border-t border-brand-gray/10">
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-brand-surface rounded-[3rem] p-10 md:p-20 flex flex-col md:flex-row gap-12 items-center text-center md:text-left shadow-2xl relative overflow-hidden">
             {/* Background Effects */}
             ...
             <div className="relative z-10 shrink-0">
               <div className="w-48 h-48 rounded-full p-2 bg-gradient-to-r from-brand-green to-brand-blue">
                 <img 
                  ...
                  alt="Akshay Mahajan" 
                  className="w-full h-full rounded-full object-cover border-4 border-brand-surface"
                />
               </div>
             </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-brand-gray font-medium mb-6 text-lg">Fitness Content Creator & AI Educator</p>
              ...
              <button 
                ...
                className="bg-brand-card text-brand-darkGreen px-8 py-3 rounded-xl font-bold hover:bg-brand-green hover:text-white transition-all inline-flex items-center group cursor-pointer border border-brand-gray/10"
              >
      ...
      {isStoryOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in-up">
          <div className="bg-brand-card w-full max-w-2xl rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="relative z-10 px-8 pt-12 pb-6 flex-shrink-0">
               <div className="w-20 h-20 rounded-2xl bg-brand-card p-1.5 shadow-xl mb-6 rotate-3">
                 <img 
                    src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=400" 
                    className="w-full h-full object-cover rounded-xl"
                 />
               </div>
               <h2 className="text-3xl font-black text-brand-darkGreen font-heading">My 20kg Weight Loss Journey</h2>
               <p className="text-brand-gray font-medium mt-2">From "I don't have time" to "It's a lifestyle".</p>
            </div>

            <div className="px-8 pb-10 overflow-y-auto custom-scrollbar">
               <div className="prose prose-lg text-brand-gray">
                  <p className="lead font-medium text-brand-darkGreen">
                  ...
                  <div className="my-8 p-6 bg-brand-surface rounded-3xl border border-brand-gray/10 flex gap-4">
                    <Quote className="text-brand-green flex-shrink-0" size={32} />
                    <p className="italic text-brand-gray m-0">
                  ...
                  <h3 className="font-bold text-brand-darkGreen text-xl mt-8 mb-4">The Turning Point</h3>
                  <p>
                  ...
                  <h3 className="font-bold text-brand-darkGreen text-xl mt-8 mb-4">What Actually Worked</h3>
                  <ul className="space-y-3 list-none pl-0">
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-green-900/20 text-green-400 flex items-center justify-center flex-shrink-0 font-bold text-xs mt-1">1</div>
                      <span><strong>Caloric Deficit:</strong> I stopped guessing portions and started tracking.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-green-900/20 text-green-400 flex items-center justify-center flex-shrink-0 font-bold text-xs mt-1">2</div>
                      <span><strong>Protein Priority:</strong> I made sure to eat 100g of protein daily to save my muscles.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-green-900/20 text-green-400 flex items-center justify-center flex-shrink-0 font-bold text-xs mt-1">3</div>
               ...
               <div className="mt-10 pt-6 border-t border-brand-gray/10 flex justify-center">
                  <button 
                    onClick={() => setIsStoryOpen(false)}
                    className="bg-brand-surface text-white px-8 py-3 rounded-xl font-bold hover:bg-brand-green transition-all shadow-lg active:scale-95 border border-brand-gray/10"
                  >
                    Close Story
                  </button>
               </div>
